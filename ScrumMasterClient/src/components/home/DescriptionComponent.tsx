...
const Description = () => {
    return (
        ...
        <CardBody>
            ...
            enter the dark cave <img className="smallIcons"src={'../../assets/cave.png'} alt=""/>  to be challenge with our code maker open ended programming syntax input box. <br/>
            ...
            <CardText>The user with the most points overall will be named, The Scrum Master.</CardText>
        </CardBody>
    </Card>
    )
}
